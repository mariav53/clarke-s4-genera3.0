    ...
    return (
				<li className="creation__design__options-font" >
					...
					<ul className={`design-fonts ${this.state.visible ? 'visible' : 'no-visible'}`}>
						<li className="font" data-font-class="cookie" value="cookie" onClick={this.props.changeFont} ><h3>Cookie</h3></li>
						<li className="font" data-font-class="annie" value="annie" onClick={this.props.changeFont}><h3>Annie</h3></li>
						<li className="font" data-font-class="philosopher" value="philosopher" onClick={this.props.changeFont}><h3>Philosopher</h3></li>
					</ul>
				</li>
