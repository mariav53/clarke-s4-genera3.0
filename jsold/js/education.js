...
const printEducationToPreview =(event)=> {
	...
	`${document.getElementById(`start_month-education${dataIdValue}`).value}  ${document.getElementById(`start_year-education${dataIdValue}`).value} - `;
	if (document.getElementById(`actualidad-education${dataIdValue}`).checked) {
		...
		`${document.getElementById(`end_month-education${dataIdValue}`).value}   ${document.getElementById(`end_year-education${dataIdValue}`).value}`;
	}
